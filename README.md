...
Let's build a model with an utmost large value of F1-measure. In addition, we will measure AUC-ROC and compare its value with F1-measure. Data source: https://www.kaggle.com/barelydedicated/bank-customer-churn-modeling | **** | 
